...
public class SmartDevice {
    ...
    private com.unisound.ant.platform.smarthome.bean.SmartStateParamter stateInfo;
    ...
    public com.unisound.ant.platform.smarthome.bean.SmartStateParamter getStateInfo() {
